...
### 회고
<ul>
<li>도대체 뭘 어떻게 접근해야 하는지 감이 안 잡혀서 다른 풀이를 참고했다</li>
<li>좌표 탐색하면서 퍼즐 찾고 빈 공간 찾는 거, 퍼즐과 빈 공간 비교하면서 들어갈 수 있는지 찾는 부분은 이해가 되는데 회전 부분이 이해가 가지 않는다</li>
</ul>

### 성능 요약

메모리: 78 MB, 시간: 1.23 ms
