...
### 회고
<ul>
<li>좌표 문제라 bfs로 동서남북 탐색하면서 진행하면 되겠다는 생각은 했다.</li>      
<li>그래서 예전에 풀었던 문제를 복기하며 풀어나갔는데 테두리를 어떻게 확인해야 하는지 감이 안 잡혔다 그래서 다른 코드를 참고해보니 맨 처음에 주어진 사각형의 좌표를 통해 테두리를 표현하는 좌표 배열을 따로 생성했다. 테두리면 1, 테두리 아니면 2를 집어 넣었다. 이 부분이 아주 신기했다.... 도대체 어떻게 이런 생각을..?</li>  
<li>그런데 왜 좌표를 2배해서 풀어야 하는 건지는 아직 잘 모르겠다</li>
</ul>

### 성능 요약

메모리: 73.2 MB, 시간: 0.50 ms
