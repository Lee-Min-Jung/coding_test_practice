...
### 회고
<ul>
<li>사각형 그리기 함수에서 겹치는 거 처리할 때가 헷갈렸음</li>
<li>그리고 뭐가 잘못된 건지 모르겠지만 계속 안 된다고 해서 예전 코드 참고해서 내가 작성했던 로직과 동일하게 했는데 그건 또 맞다네... 도대체 뭐가 문제였는지</li>
<li>최단 거리 구할 때는 모든 좌표에 대한 거리를 bfs로 구해놓으면 된다</li>
</ul>
### 성능 요약

메모리: 78.1 MB, 시간: 0.41 ms
