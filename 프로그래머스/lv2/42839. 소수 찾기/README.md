...
### 회고
<ul>
<li>재귀 활용한 dfs 구현하는 문제</li>
<li>처음에 풀었을 땐 어려웠는지 자주 풀다보니 쉬워짐...</li>
<li>추가 매개변수로 확인해야 할 수를 넘겨주는 것과 소수인 경우의 결과를 set으로 처리해서 나중에 답 리턴하는 것이 포인트</li>
</ul>

### 성능 요약

메모리: 79.2 MB, 시간: 3.90 ms
